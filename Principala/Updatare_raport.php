...
if ($_SERVER['REQUEST_METHOD'] === 'GET' && $id) {
    $r = $con->query("SELECT data, titlu, Link FROM rapoarte WHERE ID_Rapoarte=$id")->fetch_row();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        $stmt = $con->prepare("UPDATE rapoarte SET data=?, titlu=?, Link=? WHERE ID_Rapoarte=?");

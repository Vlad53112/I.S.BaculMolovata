...
if ($_SERVER['REQUEST_METHOD'] === 'GET' && $id) {
    $r = $con->query("SELECT data, titlu, Link FROM achizitie WHERE ID_Achizitie=$id")->fetch_row();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        $stmt = $con->prepare("UPDATE achizitie SET data=?, titlu=?, Link=? WHERE ID_Achizitie=?"); 
